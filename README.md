...
RevOps Security Data Stack Scorecard is a Kinetic Gain benchmark-pack repo for enterprise platform and company signals.
...
`json
{
  "product": "RevOps Security Data Stack Scorecard",
